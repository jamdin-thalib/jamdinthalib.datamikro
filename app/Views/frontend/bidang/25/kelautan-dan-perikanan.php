	...
	<div class="container">
		...
		<div class="row margin-bottom-50">
			<div class="col-md-10 col-md-offset-1 text-center">
				...
				<h2 class="section-title">Kelautan dan perikanan</h2>
			...
			<div class="row margin-bottom-30">
				<div class="col-md-12 section-white" style="padding: 30px 0;">
					<div class="col-md-5">
						...
						<div id="96" style="margin: 0 auto; width: auto"></div>
					</div>

					<div class="col-md-7">
						<h4 class="section-title">Meningkatnya produksi perikanan</h4>
						...
						<table class="data" style="width:100%">
							...
							<tbody>
								...
								<tr>
									<td><strong>Meningkatnya produksi perikanan</strong></td>
									<td align="center"></td>
									<td align="center">1723318714</td>
									<td align="center"></td>
									<td align="center"></td>
									<td style="text-align:center">%</td>
								</tr>
								<tr>
									<td>Presentase produksi perikanan budidaya</td>
									<td align="center"></td>
								...
								<tr>
									<td>Konsumsi ikan perkapita/tahun</td>
									<td align="center"></td>
...
<!-- Mirrored from edata.gorontalokota.go.id/bidang/25/kelautan-dan-perikanan by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jun 2022 06:03:28 GMT -->
