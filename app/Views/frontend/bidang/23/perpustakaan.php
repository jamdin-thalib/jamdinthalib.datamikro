 	...
 	<div class="container">
 		...
 		<div class="row margin-bottom-50">
 			<div class="col-md-10 col-md-offset-1 text-center">
 				...
 				<h2 class="section-title">Perpustakaan</h2>
 			...
 			<div class="row margin-bottom-30">
 				<div class="col-md-12 section-white" style="padding: 30px 0;">
 					<div class="col-md-5">
 						...
 						<div id="187" style="margin: 0 auto; width: auto"></div>
 					</div>

 					<div class="col-md-7">
 						<h4 class="section-title">Jumlah Pengunjung</h4>
 ...
 <!-- Mirrored from edata.gorontalokota.go.id/bidang/23/perpustakaan by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jun 2022 06:03:28 GMT -->
