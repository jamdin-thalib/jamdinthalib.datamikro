 	...
 	<div class="container">
 		...
 		<div class="row margin-bottom-50">
 			<div class="col-md-10 col-md-offset-1 text-center">
 				...
 				<h2 class="section-title">Penelitian dan pengembangan</h2>
 			...
 			<div class="row margin-bottom-30">
 				<div class="col-md-12 section-white" style="padding: 30px 0;">
 					<div class="col-md-5">
 						...
 						<div id="86" style="margin: 0 auto; width: auto"></div>
 					</div>

 					<div class="col-md-7">
 						<h4 class="section-title">Tersedianya Koneksi Internet yang merupakan layanan fasilitas keterhubungan antar SKPD untuk mengintegrasikan ,sistem informasi,pertukaran data dan Informasi dalam rangka mengimplementasikan e-goverment dan layanan publik</h4>
 						...
 						<table class="data" style="width:100%">
 							...
 							<tbody>
 								...
 								<tr>
 									<td><strong>Tersedianya Koneksi Internet yang merupakan layanan fasilitas keterhubungan antar SKPD untuk mengintegrasikan ,sistem informasi,pertukaran data dan Informasi dalam rangka mengimplementasikan e-goverment dan layanan publik</strong></td>
 									<td align="center"></td>
 									<td align="center"></td>
 									<td align="center"></td>
 									<td align="center"></td>
 ...
 <!-- Mirrored from edata.gorontalokota.go.id/bidang/39/penelitian-dan-pengembangan by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jun 2022 06:03:28 GMT -->
