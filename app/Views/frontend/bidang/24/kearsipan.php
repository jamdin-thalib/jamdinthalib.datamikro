   	...
   	<div class="container">
   		...
   		<div class="row margin-bottom-50">
   			<div class="col-md-10 col-md-offset-1 text-center">
   				...
   				<h2 class="section-title">Kearsipan</h2>
   			...
   			<div class="row margin-bottom-30">
   				<div class="col-md-12 section-white" style="padding: 30px 0;">
   					<div class="col-md-5">
   						...
   						<div id="188" style="margin: 0 auto; width: auto"></div>
   					</div>

   					<div class="col-md-7">
   						<h4 class="section-title">Tingkat ketersediaan arsip sebagai bahan akuntabilitas kinerja, alat bukti yang sah dan pertanggungjawaban nasional) Ps40 dan 59 U 43/2009)</h4>
   						<h6 class="margin-bottom-30" style="font-size: 17px;color: #f89406;">Sumber : Dinas Kearsipan dan Perpustakaan</h6>
   						<table class="data" style="width:100%">
   							...
   							<tbody>
   								...
   								<tr>
   									<td><strong>Tingkat ketersediaan arsip sebagai bahan akuntabilitas kinerja, alat bukti yang sah dan pertanggungjawaban nasional) Ps40 dan 59 U 43/2009)</strong></td>
   									<td align="center"></td>
   									<td align="center"></td>
   									<td align="center"></td>
   									<td align="center"></td>
   ...
   <!-- Mirrored from edata.gorontalokota.go.id/bidang/24/kearsipan by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jun 2022 06:03:28 GMT -->
