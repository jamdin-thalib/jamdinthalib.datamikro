<div id="doc-content" data-spy="scroll">
	<div style="padding-top: 5px;">
		...
		<div class="left">
			...
			<div class="subitle">Jumlah Penerimaan Desa</div>
		</div>
		<div class="right">
		...
		<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				<tr>
					...
					<td><strong>Jumlah Penerimaan Desa</strong></td>
				...
				<tr>
					<td></td>
					<td><strong>1. Jumlah <i>Pendapatan Asli Desa (PAD)</i></strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>2. Jumlah <i> Pajak Bumi dan Bangunan (PBB)</i></strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>3. Jumlah <i> Alokasi Dana Desa (ADD)</i></strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>4. Jumlah <i> Dana Desa (DD)</i></strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
