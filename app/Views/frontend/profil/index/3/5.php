<div id="doc-content" data-spy="scroll">
	<div style="padding-top: 5px;">
		...
		<div class="left">
			...
			<div class="subitle">Kejadian Gizi Kurang, Gizi Buruk, Stunting</div>
		</div>
		<div class="right">
			<div style="text-align: right;padding: 5px 0 5px;">
				<a href="<?= base_url('cetak/cetak18') ?>" target="_blank" class="btn_style">
		...
		<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				<tr>
					...
					<td><strong>Total Jumlah Kejadian Gizi Kurang, Gizi Buruk, Stunting</strong></td>
				...
				<tr>
					<td></td>
					<td><strong>1. Jumlah Giji Kurang</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>2. Jumlah Gizi Buruk</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>3. Jumlah Stunting</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
