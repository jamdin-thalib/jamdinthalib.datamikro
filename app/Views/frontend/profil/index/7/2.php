<div id="doc-content" data-spy="scroll">
	<div style="padding-top: 5px;">
		...
		<div class="left">
			...
			<div class="subitle">Jumlah Pangkalan / Agen LPG dan Minyak Tanah</div>
		</div>
		<div class="right">
		...
		<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				<tr>
					...
					<td><strong>Jumlah Pangkalan/Agen LPG</strong></td>
					...
					<td width="170" align="center">Dinas Perdaginkop</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td><strong>Jumlah Pangkalan/Agen Minyak Tanah</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
