<div id="doc-content" data-spy="scroll">
	<div style="padding-top: 5px;">
		...
		<div class="left">
			...
			<div class="subitle">Warung Alat Bahan Produksi Pertanian, Peternakan dan Perikan</div>
		</div>
		<div class="right">
			<div style="text-align: right;padding: 5px 0 5px;">
				<a href="<?= base_url('cetak/cetak27') ?>" target="_blank" class="btn_style">
		...
		<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				<tr>
					...
					<td><strong>Jumlah Kios Alat Bahan Produksi Pertanian, Peternakan dan Perikan</strong></td>
				...
				<tr>
					<td></td>
					<td style="padding-left:22px">1. Jumlah Warung Pertanian / Perkebunan</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td style="padding-left:22px">2. Jumlah Warung Peternakan</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td style="padding-left:22px">3. Jumlah Warung Perikanan</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
