<div id="doc-content" data-spy="scroll">
	<div style="padding-top: 5px;">
		...
		<div class="left">
			...
			<div class="subitle">Penduduk Menurut Jenis Kelamin</div>
		</div>
		<div class="right">
		...
		<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				<tr>
					...
					<td align="center" style="color: black">n/a</td>
					<?php foreach ($totalPertahun as $row) : ?>
						<td align="center" style="color: black"><?= $row['total_pria'] + $row['total_wanita'] ?></td>
					<?php endforeach ?>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">Jiwa</td>
					<td align="center" style="color: black">Desa Se Kab. Bolmut</td>
				</tr>
				<tr>
					<td></td>
					<td><strong>1. Jumlah Penduduk Laki-Laki</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<?php foreach ($totalPertahun as $row) : ?>
						<td align="center" style="color: black"><?= $row['total_pria'] ?></td>
					<?php endforeach ?>
					<td align="center" style="color: black">n/a</td>
				...
				<tr>
					<td></td>
					<td><strong>2. Jumlah Penduduk Perempuan</strong></td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<?php foreach ($totalPertahun as $row) : ?>
						<td align="center" style="color: black"><?= $row['total_wanita'] ?></td>
					<?php endforeach ?>
					<td align="center" style="color: black">n/a</td>
					<td align="center">Jiwa</td>
					<td width="170" align="center">Desa Se Kab. Bolmut</td>
				...
				<tr>
					<td></td>
					<td><strong>3. Rasio / Rata-rata Jumlah Penduduk</strong> </td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<td align="center" style="color: black">n/a</td>
					<?php foreach ($totalPertahun as $row) : ?>
						<td align="center" style="color: black"><?= round(($row['total_wanita'] / $row['total_pria']) * 100) ?></td>
					<?php endforeach ?>
					<td align="center" style="color: black">n/a</td>
					<td align="center">Jiwa</td>
					<td width="170" align="center">Desa Se Kab. Bolmut</td>
